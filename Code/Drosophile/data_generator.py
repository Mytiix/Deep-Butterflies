# -*- coding: utf-8 -*-
"""
Created on Tue Apr 13 13:39:56 2021
...
class MaskGenerator(keras.utils.Sequence):
    ...
    def __init__(self, directory, idxs, img_dict, labels_dict,
                 target_size=(256,256), batch_size=32, augment=True,
        ...
        self.images = {idx: self._load_image(self.img_dict[idx]) for idx in self.idxs}
        self.on_epoch_end()
