# -*- coding: utf-8 -*-
"""
Created on Tue Apr 13 12:47:43 2021
...
def FCN8(input_shape):
    ...
    # convolution 6
    x = Conv2D(1024, kernel_size=(1, 1), strides=1, padding="same", activation="relu", name="conv6")(x)
    ...
    output = Flatten()(x)
    output = Dense(2*nKeypoints, activation='linear', name="output")(output)
...
def UNET(input_shape):
    ...
    x= Flatten()(x)
    output = Dense(2*nKeypoints, activation='linear', name="output")(x)
    #output = Reshape(target_shape=(nKeypoints,1))(output)
