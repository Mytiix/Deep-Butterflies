# -*- coding: utf-8 -*-
"""
Created on Tue Mar 29 11:44:42 2022
...
from landmark_reg_models import *
...
def parse_data(image, lm):
    ...
    image = tf.io.decode_png(image_content, channels=channels[0])
...
if __name__ == "__main__":
    ...
    image_size = (256,256,3) # input image size to the model
...
#================= model building and training ================================    
    ...
    filepath="./lm_scripts/saved_models/unet/"+model_name+str(1)+".hdf5"
